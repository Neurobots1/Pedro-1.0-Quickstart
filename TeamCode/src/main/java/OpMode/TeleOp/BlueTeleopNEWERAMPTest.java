...
@Config
@TeleOp(name = "BlueTeleopNEWERAMPTest", group = "0")
public class BlueTeleopNEWERAMPTest extends OpMode {
    ...
    public void loop() {
        ...
        switch (intakeState) {
            case INTAKE_START:
                ...
                if (gamepad1.right_bumper) intakeTest.outtake();
                if (gamepad1.left_bumper) intakeTest.intake();
                break;
        ...
        // ✅ Telemetry showing IntakeMotor motor current
        ...
        telemetry.addData("IntakeMotor State", intakeState);
        telemetry.update();
    }
}
