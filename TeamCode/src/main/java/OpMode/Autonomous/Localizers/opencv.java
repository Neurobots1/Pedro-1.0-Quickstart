...
public class opencv extends LinearOpMode {
    ...
    public static final double focalLength = 1109;  // Replace with the focal length of the camera in pixels
    ...
    class YellowBlobDetectionPipeline extends OpenCvPipeline {
        ...
        private Mat preprocessFrame(Mat frame) {
            ...
            Scalar lowerYellow = new Scalar(60, 100, 100); //(60, 80, 50)=yellow  (100, 100, 100)=red
            Scalar upperYellow = new Scalar(60, 90, 100); //(60, 100, 100)=yellow  (180, 255, 255)=red
