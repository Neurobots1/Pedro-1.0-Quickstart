...
@Deprecated
@Autonomous(name = "AutonomousSpec5", group = "Unused")
public class AutonomousSpec5 extends OpMode {
    ...
    private final Pose clipPose1 = new Pose(37, 82, Math.toRadians(270));
    private final Pose clipPose2 = new Pose(37, 80, Math.toRadians(180));
    private final Pose clipPose3 = new Pose(37, 78, Math.toRadians(180));
    private final Pose clipPose4 = new Pose(37, 76, Math.toRadians(180));
    private final Pose clipPose5 = new Pose(37, 74, Math.toRadians(180));
    ...
    private final Pose wallPose = new Pose(10, 30, Math.toRadians(0));
    private final Pose  PrewallPose = new Pose(17,30, Math.toRadians(0));
    ...
    private PathChain pathChain1, pathChain2, pathChain3, pathChain4, pathChain5, pathChain6, pathChain7, pathChain8, pathChain9, pathChain10, pathChain11, pathChain12, pathChain13, pathChain14, pathChain15, pathChain16, pathChain17, pathChain18;
    ...
    public void buildPaths() {
        ...
        pathChain13 = follower.pathBuilder()
                .addPath(new BezierLine(
                        new Point(PrewallPose),
                        new Point(wallPose)
                ))
        ...
        pathChain14 = follower.pathBuilder()
                .addPath(new BezierLine(
                        new Point(wallPose),
                        new Point(clipPose4)
                ))
        ...
        pathChain15 = follower.pathBuilder()
                .addPath(new BezierLine(
                        new Point(clipPose4),
                        new Point(PrewallPose)
                ))
        ...
        pathChain16 = follower.pathBuilder()
                .addPath(new BezierLine(
                        new Point(PrewallPose),
                        new Point(wallPose)
                ))
        ...
        pathChain17 = follower.pathBuilder()
                .addPath(new BezierLine(
                        new Point(wallPose),
                        new Point(clipPose5)
                ))
        ...
        pathChain18 = follower.pathBuilder()
                .addPath(new BezierLine(
                        new Point(clipPose5),
                        new Point(PrewallPose)
                ))
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 2:
                    ...
                    follower.followPath(pathChain3,0.7, false);
            ...
            case 3: //
                if (!follower.isBusy()) {
                    follower.followPath(pathChain5,0.3, false);
                    pathTimer.resetTimer();
                    setPathState(4);
              ...
              case 4: //
                if (!follower.isBusy()) {
                    ...
                    follower.followPath(pathChain7,0.7, false);
                    viperSlides.setTarget(ViperSlides.Target.MEDIUM);
                    pathTimer.resetTimer();
                    setPathState(5);
            ...
            case 6: //
                if (!follower.isBusy()) {
                    follower.followPath(pathChain10,0.7, false);
                    pathTimer.resetTimer();
                    setPathState(7);
                }
                break;
            ...
            case 7: //
                if (!follower.isBusy()) {
                    follower.followPath(pathChain10,0.3, false);
                    pathTimer.resetTimer();
                    setPathState(8);
                }
                break;
            ...
            case 8:
                ...
                follower.followPath(pathChain11, 0.7, true);
                viperSlides.setTarget(ViperSlides.Target.MEDIUM);
                pathTimer.resetTimer();
                setPathState(9);
            ...
            case 10:
                    if (pathTimer.getElapsedTimeSeconds() > 0 && pathTimer.getElapsedTimeSeconds() < 1) {
                        follower.followPath(pathChain12, 0.7, false);
                    }
            ...
            case 11: //
                follower.followPath(pathChain13, 0.3, true);
                pathTimer.resetTimer();
                setPathState(12);
            ...
            case 12:
                ...
                follower.followPath(pathChain9, 0.7, true);
                pathTimer.resetTimer();
                setPathState(13);
